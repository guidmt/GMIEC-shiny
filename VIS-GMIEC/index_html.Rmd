...
res.pc3<-prcomp(matrix_sadrugs2[,-1])
...
for (i in rownames(matrix_sad)){
  
  string<-paste(paste("[",paste(i," |",sep=""),sep=""),"]",sep="")
  link_to_string<-paste(paste("(",paste(paste(paste(getwd(),"output_vis/",sep="/"),paste("report.",i,sep=""),sep=""),".html",sep=""),sep=""),")",sep="")
